package com.json.observer.application.utils;
...
public class MD5Encrypt
{
	public static void main(String[] args) {
		String psw="123@!";
		String pswEntry=MD5Encrypt.getEncryptedPwd(psw);
		System.out.println(pswEntry);
		try {
			boolean dd=MD5Encrypt.validPassword(pswEntry, "123@");
